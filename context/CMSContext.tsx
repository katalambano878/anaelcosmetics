...
const defaultSettings: SiteSettings = {
    site_name: 'ANAEL',
    site_tagline: 'Premium quality lip glosses, lip liners, lashes, hair clips & makeup bags.',
    site_logo: '/anael-logo.png',
    contact_email: '',
    contact_phone: '0242853166',
    contact_address: 'Accra, Ghana',
    social_facebook: '',
    social_instagram: 'anael_cosmeticss',
    social_twitter: '',
    social_tiktok: 'anael_cosmetics',
    social_snapchat: 'Hira3166',
    social_youtube: '',
